...
import { getAdminDashboardMessages } from "@/i18n/admin";
...
export default async function page({ params }) {
  ...
  const translatedTexts = getAdminDashboardMessages(targetLanguage);
      ...
      <main className="main-content">
        ...
        <div className="content-wrapper js-content-wrapper overflow-hidden">
          ...
          >
            ...
            <DashboardOne translatedTexts={translatedTexts} />
          </div>
        </div>
      </main>
    </div>

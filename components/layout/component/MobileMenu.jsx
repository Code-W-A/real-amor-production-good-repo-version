...
export default function MobileMenu({
  ...
  const profilePath = withLocalePath(pathname, "/profil-client");
  return (
    <div
        ...
        <div className="d-none xl:d-flex items-center px-20 py-20 border-bottom-light">
          {!currentUser ? (
            <>
              <Link
                ...
                className={`text-dark-1 ${
                  pathname == loginPath ? "activeMenu" : "inActiveMenu"
                } `}
              >
              ...
              <Link
                ...
                className={`text-dark-1 ml-30 ${
                  pathname == signupPath ? "activeMenu" : "inActiveMenu"
                } `}
              >
            ...
            <Link
              href={profilePath}
              className={`text-dark-1 ml-30 ${
                pathname == profilePath ? "activeMenu" : "inActiveMenu"
              } `}
            >

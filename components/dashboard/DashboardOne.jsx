...
export default function DashboardOne({ translatedTexts }) {
  const { userData, currentUser, loading } = useAuth();
  const [isRedirecting, setIsRedirecting] = useState(true);
  const router = useRouter();
  useEffect(() => {
    const uid = currentUser?.uid || currentUser?.user?.uid;
    if (!loading && !isAdminUid(uid)) {
      ...
      <div className="row pb-50 mb-10">
        <div className="col-auto">
          <h1 className="text-30 lh-12 fw-700">
            {translatedTexts?.loadingText || "Loading..."}
          </h1>
          {/* <div className="mt-10">
    ...
    <div className="dashboard__main">
      <div className="dashboard__content bg-light-4">
        <div className="row pb-50 mb-10">
          <div className="col-auto">
            <h1 className="text-30 lh-12 fw-700">
              {translatedTexts?.adminDashboardTitleText || "Cont Admin"}
            </h1>
            {/* <div className="mt-10">
              Lorem ipsum dolor sit amet, consectetur.
            </div> */}

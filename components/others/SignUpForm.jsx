...
const SignUpForm = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.email) {
      errors.email = translatedLinks.emailRequiredText;
      isValid = false;
    }
    ...
    if (formData.password.length < 6) {
      errors.password = translatedLinks.passwordMinLengthText;
      isValid = false;
    }
    ...
    if (!formData.phone) {
      ...
      const phoneCheck = normalizePhone({
        ...
        errors.phone = translatedLinks.phoneInvalidText;
        isValid = false;
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (!normalizedPhone.isValid) {
      setFormErrors((prev) => ({
        ...prev,
        phone: translatedLinks.phoneInvalidText,
      }));
      setAlertMessage({
        type: "danger",
        content: translatedLinks.phoneInvalidText,
        showAlert: true,
      });
      return;
    }
        ...
        <div className="row justify-center items-center">
          <div className="col-xl-11 col-lg-11">
            ...
            >
              ...
              <p className="mt-10">
                {alreadyHaveAccountText}
                <Link href={loginPath} className="text-purple-1">
                  {conectText}
                </Link>
              </p>
                ...
                <div className="col-12">
                  {isLoading ? (
                    <div className="spinner">
                      {" "}
                      {/* Spinner component */}
                      <span>{translatedLinks.loadingText}</span>
                    </div>
                  ) : (
                    <button
                      type="submit"

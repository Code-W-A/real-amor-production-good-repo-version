...
export default function LoginForm({
  ...
  const signupPath = withLocalePath(pathname, "/signup");
  const resetPasswordPath = withLocalePath(pathname, "/reset-password");
  const quizPath = withLocalePath(pathname, "/quiz");
        ...
        <div className="row justify-center items-center">
          <div className="col-xl-9 col-lg-9">
            <div className="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
              ...
              <p className="mt-10">
                {aiContText}
                <Link href={signupPath} className="text-purple-1">
                  {" "}
                  {inscrieText}
                </Link>
              </p>
              ...
              <p className="mt-10">
                ...
                <Link href={resetPasswordPath} className="text-purple-1">
                  {" "}
